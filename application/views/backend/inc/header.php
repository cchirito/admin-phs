        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?= base_url() ?>" class="site_title"><i class="fa fa-paw"></i> <span>Empresa!</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?= base_url('assets/images/img.jpg') ?>" alt="Foto de perfíl" class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?= base_url('backend/dashboard') ?>"><i class="fa fa-home"></i> Dashboard</a>
                  </li>
                  <li><a href="<?= base_url('backend/ajustes') ?>"><i class="fa fa-pencil"></i> Ajustes</a>
                  </li>
